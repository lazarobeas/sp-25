...
public class LinkedListDeque61BTest {
    ...
    @Test
    public void checkIfEmptyAndNonEmpty() {
         Deque61B<Integer> lld1 = new LinkedListDeque61B<>();
         /* This test checks if the LL is empty and then nonempty */
    ...
    public void checkSize() {
         ...
         lld1.addFirst("Hey"); // ["Hey"]
         lld1.addLast("Beans"); // ["Hey","Beans]

         assertThat(lld1.size()).isEqualTo(2);

         lld1.addLast("Okay"); // ["Hey","Beans","Okay"]
         lld1.addLast("Don't"); // ["Hey","Beans","Okay","Don't"]
         lld1.removeFirst(); // ["Beans","Okay","Don't"]

        assertThat(lld1.size()).isEqualTo(3);

        lld1.removeLast(); // ["Beans","Okay"]
        assertThat(lld1.size()).isEqualTo(2);
